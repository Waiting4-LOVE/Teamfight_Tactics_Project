...
_2star_flyDragon* _2star_flyDragon::createhero() {
	...
	auto temp = Sprite::create("flyDragon.png");
	temp->setScale(2.5);
	_2star_flyDragon->bloodBar->setBarChangeRate(Point(1, 0));
	_2star_flyDragon->bloodBar->setType(ProgressTimer::Type::BAR);
	_2star_flyDragon->bloodBar->setMidpoint(Point(0, 1));
	_2star_flyDragon->bloodBar->setScaleX(0.22);
	_2star_flyDragon->scheduleUpdate();
	//flyDragon->addChild(flyDragon->bloodBar, 2);
	_2star_flyDragon->picturename = "flyDragon.png";
	_2star_flyDragon->addChild(temp);

	_2star_flyDragon->schedule(CC_SCHEDULE_SELECTOR(hero::bloodUpdate), 1 / 60.0f);

	_2star_flyDragon->schedule(CC_SCHEDULE_SELECTOR(hero::attack), 1 / _2star_flyDragon->speedAttack);
...
_3star_flyDragon* _3star_flyDragon::createhero() {
	...
	auto temp = Sprite::create("flyDragon.png");
	temp->setScale(2.5);
	_3star_flyDragon->bloodBar->setBarChangeRate(Point(1, 0));
	_3star_flyDragon->bloodBar->setType(ProgressTimer::Type::BAR);
	_3star_flyDragon->bloodBar->setMidpoint(Point(0, 1));
	_3star_flyDragon->bloodBar->setScaleX(0.22);
	_3star_flyDragon->scheduleUpdate();
	//flyDragon->addChild(flyDragon->bloodBar, 2);
	_3star_flyDragon->picturename = "flyDragon.png";
	_3star_flyDragon->addChild(temp);

	_3star_flyDragon->schedule(CC_SCHEDULE_SELECTOR(hero::bloodUpdate), 1 / 60.0f);

	_3star_flyDragon->schedule(CC_SCHEDULE_SELECTOR(hero::attack), 1 / _3star_flyDragon->speedAttack);
